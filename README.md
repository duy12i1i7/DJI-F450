...
Firstly, you've got to have Unity installed (obviously), and secondly, you should make sure 2 models below that is available in this project.
...
So I fixed it and exported a Unity package based on a FBX file. This package located `model` folder
